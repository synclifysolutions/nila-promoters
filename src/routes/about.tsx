    ...
    <div ref={ref} className="absolute inset-0 overflow-hidden">
      <motion.div style={{ y }} className="absolute inset-[-20%]">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 30% 50%, rgba(249,244,241,0.35) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(249,244,241,0.16) 0%, transparent 50%)",
          }}
        />
      </motion.div>
    </div>
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white py-28">
        <div className="absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-[#1B3650]/4 to-transparent pointer-events-none" />
        <div className="mx-auto max-w-5xl px-6">
          <FadeUp className="mb-20 text-center">
            ...
            <h2 className="mt-4 font-display text-4xl font-bold text-[#0F2235] md:text-5xl">
...
export function PageBanner({ title, crumbs }: { title?: string; crumbs?: string[] }) {
  ...
  return (
    <section className="relative min-h-[52vh] overflow-hidden bg-[#0F2235] flex items-end pb-20 pt-36">
      <div className="absolute inset-0">
        <div
          className="absolute inset-0"
          style={{
